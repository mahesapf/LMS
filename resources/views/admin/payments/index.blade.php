...
@section('content')
<div class="space-y-6" x-data="{ openHistoryId: null, openPendingId: null, showRejectModal: false, rejectPaymentId: null, rejectPaymentUrl: '' }">
                        ...
                        <tbody class="divide-y divide-slate-100 bg-white">
                            ...
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-4 py-2 text-sm">
                                    ...
                                    <div class="text-xs text-slate-500">{{ $payment->registration->kab_kota }}, {{ $payment->registration->provinsi }}</div>
                                </td>
                                    ...
                                    <div class="bg-white rounded-lg border border-slate-200 p-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                                            <div class="p-3 bg-amber-50 rounded-lg border border-amber-200">
                                                ...
                                                <p class="text-lg font-bold text-amber-900">Rp {{ number_format($payment->amount, 0, ',', '.') }}</p>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                            ...
                                            <div class="p-4 bg-slate-50 rounded-lg border border-slate-200">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <div>
                                                        <p class="text-xs text-slate-600">Biaya Pendaftaran</p>
                                                        <p class="text-sm text-slate-900">Rp {{ number_format($payment->registration->activity->registration_fee, 0, ',', '.') }}</p>
                                                    </div>
                                                    <div>
                                        ...
                                        <div class="flex gap-3 justify-end pt-4 border-t border-slate-200">
                                            <form action="{{ route('super-admin.payments.approve', $payment) }}" method="POST" class="inline-block">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" class="inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-emerald-600 rounded-md hover:bg-emerald-700 shadow-sm"
                                            ...
                                            <button type="button" 
                                                    ...
                                                    class="inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-rose-600 rounded-md hover:bg-rose-700 shadow-sm">
                                                <svg class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-4 py-2 text-sm">
                                <div class="text-slate-900 font-semibold">{{ $payment->registration->nama_sekolah }}</div>
                                <div class="text-xs text-slate-500">{{ $payment->registration->kab_kota }}</div>
                            </td>
                            <td class="px-4 py-2 text-sm text-slate-700">
                                {{ $payment->registration->activity->name }}
                                @if($payment->registration->activity->program)
