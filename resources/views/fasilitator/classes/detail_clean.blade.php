...
<div class="space-y-6" x-data="{ activeTab: 'participants' }">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">{{ $class->activity->name ?? '-' }}</p>
        </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-900">{{ $participants->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-900">{{ $class->max_participants ?? '∞' }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-900">{{ $stages->sum(fn($s) => $s->documentRequirements->count()) }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center gap-3">
                @if($class->status == 'open')
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-emerald-700">Buka</p>
                    </div>
                @elseif($class->status == 'closed')
                    ...
                    <div>
                        <p class="text-sm text-slate-500">Status</p>
                        <p class="text-xl font-bold text-amber-700">Tutup</p>
                    </div>
                @else
                    ...
                    <div>
                        <p class="text-sm text-slate-500">Status</p>
                        <p class="text-xl font-bold text-slate-700">Selesai</p>
                    </div>
                @endif
            </div>
        </div>
                            ...
                            <div class="flex items-start justify-between rounded-lg border border-slate-200 bg-slate-50 p-4">
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if($task->is_required)
                                            <span class="inline-flex items-center rounded-full bg-rose-100 px-2 py-0.5 text-xs font-semibold text-rose-700">Wajib</span>
                                        @else
                                            <span class="inline-flex items-center rounded-full bg-slate-200 px-2 py-0.5 text-xs font-semibold text-slate-700">Opsional</span>
                                        @endif
                                    </div>
                ...
                <div @click.away="showAddTaskModal = false" class="w-full max-w-md rounded-xl bg-white shadow-xl">
                    ...
                    <form action="{{ route('fasilitator.tasks.store', $class) }}" method="POST" class="px-6 py-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="document_type" required class="w-full rounded-lg border border-slate-300 px-3 py-2 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-200" placeholder="PDF, Word, Excel">
                        </div>
                        <div>
                            ...
                            @foreach($reqs as $req)
                                ...
                                <div class="flex items-start justify-between rounded-lg border border-slate-200 bg-slate-50 p-4">
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-2">
                                            @if($uploaded)
                                                <span class="inline-flex items-center gap-1 rounded-full bg-emerald-100 px-2.5 py-0.5 text-xs font-semibold text-emerald-700">Sudah Upload</span>
                                            @else
                                                <span class="inline-flex items-center gap-1 rounded-full bg-amber-100 px-2.5 py-0.5 text-xs font-semibold text-amber-700">Belum Upload</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="ml-4 flex gap-2">
