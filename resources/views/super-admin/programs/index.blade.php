...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('super-admin.programs.create') }}" class="inline-flex items-center gap-2 rounded-lg bg-sky-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-700">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-2 text-sm">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('super-admin.programs.edit', $program) }}" class="inline-flex items-center rounded-md bg-amber-500 px-2.5 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-amber-600">Edit</a>
