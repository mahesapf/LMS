                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-2 text-sm">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route($routePrefix . '.activities') }}?edit={{ $activity->id }}" class="inline-flex items-center rounded-md bg-amber-500 px-2.5 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-amber-600">Edit</a>
