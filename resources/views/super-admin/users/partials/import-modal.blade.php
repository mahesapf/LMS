                    ...
                    <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <div class="mt-4 grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="file" name="file" class="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm file:mr-2 file:rounded file:border-0 file:bg-sky-100 file:px-2 file:py-1 file:text-sm file:font-semibold file:text-sky-700 hover:file:bg-sky-200 @error('file') border-red-500 @enderror" accept=".csv" required>
                                @error('file')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
