                    ...
                    <div class="mr-4 md:mr-8 flex items-center gap-2">
                        ...
                        <div tabindex="0" role="button" class="flex items-center gap-2">
                            ...
                            <div class="hidden sm:flex flex-col items-start leading-tight">
                                <p class="text-sm font-semibold text-slate-900"><?php echo e(Auth::user()->email); ?></p>
                                <span class="text-xs font-medium text-slate-500"><?php echo e(ucfirst(str_replace('_',' ', Auth::user()->role))); ?></span>
                            </div>
                        </div>
                        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-lg bg-white rounded-lg w-56 border border-slate-100">
                            <li class="menu-title px-4 py-2">
                                <span class="text-slate-900 font-semibold"><?php echo e(Auth::user()->name); ?></span>
                                <span class="text-xs text-slate-500"><?php echo e(Auth::user()->email); ?></span>
                            </li>
                            <div class="divider my-1"></div>
                            <li>
                                <a href="<?php echo e(route('home')); ?>" class="text-slate-700 hover:bg-sky-50 hover:text-sky-700 rounded-md">
                            ...
                            <li>
                                <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="text-red-600 hover:bg-red-50 rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="p-4 lg:p-8 flex-1 overflow-y-auto">
                <?php if(session('success')): ?>
                    <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 2000)" x-show="show" x-transition class="mb-4 flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-emerald-900 shadow-sm">
                        ...
                        <div class="flex-1 text-sm font-semibold"><?php echo e(session('success')); ?></div>
                    </div>
                <?php endif; ?>
                ...
                <?php if(session('error')): ?>
                    <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 2500)" x-show="show" x-transition class="mb-4 flex items-start gap-3 rounded-xl border border-rose-200 bg-rose-50 px-4 py-3 text-rose-900 shadow-sm">
                        ...
                        <div class="flex-1 text-sm font-semibold"><?php echo e(session('error')); ?></div>
                    </div>
                <?php endif; ?>
            ...
            <div class="w-80 h-screen overflow-y-auto bg-white text-slate-900 border-r border-slate-200 shadow-lg">
                ...
                <div class="p-6 border-b border-slate-200">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e(asset('storage/tut-wuri-handayani-kemdikdasmen-masafidhan.svg')); ?>" alt="Tut Wuri Handayani" class="h-12 w-12 object-contain">
                        <div class="leading-tight">
                            <h2 class="text-[17px] font-semibold text-slate-900"><?php echo e(config('app.name', 'SIPM')); ?></h2>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\LMS\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>