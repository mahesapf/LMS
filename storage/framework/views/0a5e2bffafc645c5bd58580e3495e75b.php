...
<div class="container-fluid">
    <div class="mb-4">
        ...
        <a href="<?php echo e(route('super-admin.activities')); ?>" class="btn btn-secondary">Kembali</a>
    </div>

    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('super-admin.activities.store')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('registration_fee', 0)); ?>" min="0" step="0.01">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('super-admin.activities')); ?>" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LMS\resources\views/super-admin/activities/create.blade.php ENDPATH**/ ?>