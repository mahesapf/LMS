    ...
    <div class="rounded-2xl bg-gradient-to-br from-sky-600 to-blue-700 px-6 py-8 text-white shadow-sm">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-3">
                <a href="<?php echo e(route('super-admin.users')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-white/20 px-4 py-2 text-sm font-semibold backdrop-blur transition hover:bg-white/30">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                    </svg>
                    Tambah pengguna
                </a>
                <a href="<?php echo e(route('super-admin.activities')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-white text-sky-700 px-4 py-2 text-sm font-semibold shadow-sm transition hover:shadow">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-slate-900"><?php echo e($stats['total_admins']); ?></p>
                </div>
            </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-slate-900"><?php echo e($stats['total_fasilitators']); ?></p>
                </div>
            </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-slate-900"><?php echo e($stats['total_participants']); ?></p>
                </div>
            </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-slate-900"><?php echo e($stats['total_programs']); ?></p>
                </div>
            </div>
        ...
        <div class="lg:col-span-2 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="flex items-start justify-between gap-4">
                <div>
                    ...
                    <h2 class="mt-1 text-2xl font-semibold text-slate-900"><?php echo e($stats['total_activities']); ?> kegiatan aktif</h2>
                    <p class="mt-2 text-sm text-slate-500">Ikuti detail jadwal, pendanaan, dan progres kegiatan.</p>
                </div>
                <a href="<?php echo e(route('super-admin.activities')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-sky-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-700">
                    Lihat kegiatan
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <div class="rounded-lg border border-slate-200 bg-slate-50 p-4">
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('super-admin.payments.index')); ?>" class="text-sm font-semibold text-sky-700 hover:text-sky-800">Kelola pembayaran →</a>
                    </div>
                </div>
                <div class="rounded-lg border border-slate-200 bg-slate-50 p-4">
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('super-admin.users')); ?>" class="text-sm font-semibold text-sky-700 hover:text-sky-800">Buka manajemen →</a>
                    </div>
                </div>
                <div class="rounded-lg border border-slate-200 bg-slate-50 p-4">
                    ...
                    <div class="mt-3 flex flex-wrap gap-2 text-sm font-semibold">
                        <a href="<?php echo e(route('super-admin.programs')); ?>" class="text-sky-700 hover:text-sky-800">Program →</a>
                        <span class="text-slate-300">|</span>
                        <a href="<?php echo e(route('super-admin.classes.index')); ?>" class="text-sky-700 hover:text-sky-800">Kelas →</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-4 py-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-slate-900"><?php echo e($stats['total_activities']); ?> total</p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('super-admin.activities')); ?>" class="text-sm font-semibold text-sky-700 hover:text-sky-800">→</a>
                </div>
                <div class="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-4 py-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-slate-900"><?php echo e($stats['total_programs']); ?> program</p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('super-admin.programs')); ?>" class="text-sm font-semibold text-sky-700 hover:text-sky-800">→</a>
                </div>
                <div class="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-4 py-3">
                    <div class="flex items-center gap-3">
                        <span class="flex h-9 w-9 items-center justify-center rounded-lg bg-white text-slate-700 shadow-sm">
                    ...
                    <a href="<?php echo e(route('super-admin.admin-mappings')); ?>" class="text-sm font-semibold text-sky-700 hover:text-sky-800">→</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LMS\resources\views/super-admin/dashboard.blade.php ENDPATH**/ ?>