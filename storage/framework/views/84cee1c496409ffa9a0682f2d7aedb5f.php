...
<div class="space-y-6" x-data="{
    ...
    <div class="rounded-xl border border-amber-200 bg-white shadow-sm">
        <div class="border-b border-amber-200 bg-amber-50 px-4 py-3">
            <h2 class="text-sm font-semibold text-amber-800">Pembayaran Menunggu Validasi (<?php echo e($payments->count()); ?>)</h2>
        </div>
        <div class="p-4">
                    ...
                    <table class="min-w-full divide-y divide-slate-200">
                        ...
                        <tbody class="divide-y divide-slate-100 bg-white">
                            ...
                            <tr class="hover:bg-slate-50">
                                <td class="px-4 py-2 text-sm text-slate-700"><?php echo e($payment->created_at->format('d M Y H:i')); ?></td>
                                <td class="px-4 py-2 text-sm">
                                    <div class="text-slate-900 font-semibold"><?php echo e($payment->registration->nama_sekolah); ?></div>
                                    <div class="text-xs text-slate-500">
                                        <?php echo e($payment->registration->kecamatan ? $payment->registration->kecamatan . ', ' : ''); ?><?php echo e($payment->registration->kab_kota); ?>, <?php echo e($payment->registration->provinsi); ?>

                                    </div>
                                </td>
                                <td class="px-4 py-2 text-sm text-slate-700">
                                    <?php echo e($payment->registration->activity->name); ?>

                                    <?php if($payment->registration->activity->program): ?>
                                        <div class="text-xs text-slate-500"><?php echo e($payment->registration->activity->program->name); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-4 py-2 text-sm text-slate-700">
                                    <span class="font-semibold"><?php echo e($totalPeserta); ?></span> orang
                                    <div class="text-xs text-slate-500">KS: <?php echo e($payment->registration->jumlah_kepala_sekolah); ?>, Guru: <?php echo e($payment->registration->jumlah_guru); ?></div>
                                </td>
                                <td class="px-4 py-2 text-sm text-slate-700">Rp <?php echo e(number_format($payment->amount, 0, ',', '.')); ?></td>
                                <td class="px-4 py-2 text-sm text-slate-700"><?php echo e(\Carbon\Carbon::parse($payment->payment_date)->format('d M Y')); ?></td>
                                <td class="px-4 py-2 text-sm">
                                    <button @click="openPendingId = openPendingId === <?php echo e($payment->id); ?> ? null : <?php echo e($payment->id); ?>"
                            ...
                            <!-- Detail Row -->
                            <tr x-show="openPendingId === <?php echo e($payment->id); ?>"
                                x-transition
                                class="bg-slate-50">
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div class="p-4 rounded-xl bg-gradient-to-br from-amber-50 to-amber-100 border border-amber-200">
                                                ...
                                                <p class="text-2xl font-bold text-amber-900">Rp <?php echo e(number_format($payment->amount, 0, ',', '.')); ?></p>
                                            </div>
                                            <div class="p-4 rounded-xl bg-gradient-to-br from-sky-50 to-sky-100 border border-sky-200">
                                                ...
                                                <p class="text-lg font-semibold text-sky-900"><?php echo e(\Carbon\Carbon::parse($payment->payment_date)->format('d M Y')); ?></p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="p-4 rounded-lg border border-slate-200 bg-white">
                                                ...
                                                <div class="space-y-2">
                                                    <div>
                                                        ...
                                                        <p class="text-sm font-semibold text-slate-900"><?php echo e($payment->registration->nama_sekolah); ?></p>
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm font-semibold text-slate-900"><?php echo e($payment->registration->nama_kepala_sekolah ?? '-'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-slate-500">KCD</p>
                                                        <p class="text-sm text-slate-900"><?php echo e($payment->registration->kcd ?? '-'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="p-4 rounded-lg border border-slate-200 bg-white">
                                                ...
                                                <div class="space-y-2">
                                                    <div>
                                                        ...
                                                        <p class="text-sm font-semibold text-slate-900"><?php echo e($payment->registration->activity->program->name ?? '-'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-slate-500">Nama Kegiatan</p>
                                                        <p class="text-sm font-semibold text-slate-900"><?php echo e($payment->registration->activity->name); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-slate-500">Biaya & Peserta</p>
                                                        <p class="text-sm text-slate-900">Rp <?php echo e(number_format($payment->registration->activity->registration_fee, 0, ',', '.')); ?> × <?php echo e($totalPeserta); ?> orang</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-4 rounded-lg border border-slate-200 bg-white">
                                            ...
                                            <div class="space-y-2">
                                                <?php if($payment->registration->jumlah_kepala_sekolah > 0): ?>
                                                <div class="flex items-center justify-between p-3 rounded-lg bg-emerald-50 border border-emerald-200">
                                                    <div>
                                                        <p class="text-sm font-semibold text-emerald-900"><?php echo e($payment->registration->kepala_sekolah); ?></p>
                                                ...
                                                <?php endif; ?>
                                                <?php if($payment->registration->teacherParticipants->count() > 0): ?>
                                                <div class="p-3 rounded-lg bg-sky-50 border border-sky-200">
                                                    <div class="flex items-center justify-between mb-2">
                                                        <p class="text-sm font-semibold text-sky-900">Guru-Guru</p>
                                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-sky-200 text-sky-800"><?php echo e($payment->registration->teacherParticipants->count()); ?></span>
                                                    </div>
                                                    <div class="space-y-1">
                                                        <?php $__currentLoopData = $payment->registration->teacherParticipants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <p class="text-xs text-sky-700">• <?php echo e($teacher->nama_lengkap); ?></p>
                                        ...
                                        <div class="p-4 rounded-lg border border-slate-200 bg-white">
                                            ...
                                            <img src="<?php echo e(Storage::url($payment->proof_file)); ?>" alt="Bukti Transfer" class="rounded border border-slate-300 shadow-sm w-full max-h-80 object-contain">
                                        </div>
                                        <?php endif; ?>

                                        <!-- Action Buttons -->
                                        <div class="flex gap-3 justify-end pt-2 border-t border-slate-200">
                                            <form action="<?php echo e(route('super-admin.payments.approve', $payment)); ?>" method="POST" class="inline-block">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <button type="button"
                                                    @click="showRejectModal = true; rejectPaymentId = <?php echo e($payment->id); ?>; rejectPaymentUrl = '<?php echo e(route('super-admin.payments.reject', $payment)); ?>'"
        ...
        <div class="border-b border-slate-200 bg-slate-50 px-4 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <form method="GET" action="<?php echo e(route('super-admin.payments.index')); ?>" class="flex items-center gap-2">
                        <select name="activity_id" id="activity_filter"
                            ...
                            <option value="<?php echo e($activity->id); ?>" <?php echo e(request('activity_id') == $activity->id ? 'selected' : ''); ?>>
                                ...
                                <?php if($activity->program): ?>
                                    - <?php echo e($activity->program->name); ?>

                                <?php endif; ?>
                            </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php if(request('activity_id')): ?>
                    ...
                    <div class="flex items-center gap-2">
                        <button @click="if(selectedSchools.length === 0) { alert('Pilih minimal 1 sekolah untuk di ekspor'); return; }
                                        ...
                                        form.method = 'POST';
                                        form.action = '<?php echo e(route('super-admin.payments.export-by-schools')); ?>';
                        ...
                        <a href="<?php echo e(route('super-admin.payments.export-participants', ['activity_id' => request('activity_id')])); ?>"
        ...
        <div class="p-4">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        <?php $__empty_1 = true; $__currentLoopData = $validatedPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50">
                            <td class="px-4 py-2">
                                <input type="checkbox"
                                       class="school-checkbox rounded border-slate-300 text-sky-600 focus:ring-sky-500"
                                       :checked="selectedSchools.includes(<?php echo e($payment->id); ?>)"
                                       @change="toggleSchool(<?php echo e($payment->id); ?>)"
                                       value="<?php echo e($payment->id); ?>">
                            </td>
                            <td class="px-4 py-2 text-sm text-slate-700"><?php echo e($payment->validated_at->format('d M Y H:i')); ?></td>
                            <td class="px-4 py-2 text-sm">
                                <div class="text-slate-900 font-semibold"><?php echo e($payment->registration->nama_sekolah); ?></div>
                                <div class="text-xs text-slate-500">
                                    <?php echo e($payment->registration->kecamatan ? $payment->registration->kecamatan . ', ' : ''); ?><?php echo e($payment->registration->kab_kota); ?><?php echo e($payment->registration->provinsi ? ', ' . $payment->registration->provinsi : ''); ?>
                            ...
                            <td class="px-4 py-2 text-sm text-slate-700">
                                <?php
                                    $totalPeserta = $payment->registration->jumlah_peserta > 0
                                        ...
                                        : ($payment->registration->jumlah_kepala_sekolah + $payment->registration->jumlah_guru);
                                ?>
                                <?php echo e($totalPeserta); ?> orang
                            </td>
                            <td class="px-4 py-2 text-sm text-slate-700">Rp <?php echo e(number_format($payment->amount, 0, ',', '.')); ?></td>
                            <td class="px-4 py-2 text-sm">
                                <span class="inline-flex rounded-full bg-emerald-100 px-2.5 py-0.5 text-xs font-semibold text-emerald-700">Tervalidasi</span>
                            </td>
                            <td class="px-4 py-2 text-sm text-slate-700"><?php echo e($payment->validator->name ?? '-'); ?></td>
                            <td class="px-4 py-2 text-sm">
                                <div class="flex items-center gap-1">
                                    <button @click="openHistoryId = openHistoryId === <?php echo e($payment->id); ?> ? null : <?php echo e($payment->id); ?>"
                                    ...
                                    <a href="<?php echo e(route('super-admin.payments.export-single', $payment)); ?>"
                        ...
                        <!-- Detail Row -->
                        <tr x-show="openHistoryId === <?php echo e($payment->id); ?>"
                            x-transition
                            class="bg-slate-50">
                                ...
                                <div class="bg-white rounded-lg border border-slate-200 p-4">
                                        ...
                                        <div class="flex items-start gap-3">
                                            <div class="flex-1">
                                                ...
                                                <p class="text-sm text-emerald-700">
                                                    Validator: <?php echo e($payment->validator->name ?? '-'); ?> | <?php echo e($payment->validated_at->format('d M Y H:i')); ?>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                                        <div class="p-3 bg-sky-50 rounded-lg border border-sky-200">
                                            ...
                                            <p class="text-lg font-bold text-sky-900">Rp <?php echo e(number_format($payment->amount, 0, ',', '.')); ?></p>
                                        </div>
                                        <div class="p-3 bg-slate-50 rounded-lg border border-slate-200">
                                            <p class="text-xs font-medium text-slate-600 mb-1">Tanggal Transfer</p>
                                            <p class="text-sm font-semibold text-slate-900"><?php echo e(\Carbon\Carbon::parse($payment->payment_date)->format('d M Y')); ?></p>
                                        </div>
                                        <div class="p-3 bg-slate-50 rounded-lg border border-slate-200">
                                            <p class="text-xs font-medium text-slate-600 mb-1">Kontak</p>
                                            <p class="text-sm font-semibold text-slate-900"><?php echo e($payment->contact_number ?? '-'); ?></p>
                                        </div>
                                        <div class="p-3 bg-slate-50 rounded-lg border border-slate-200">
                                            <p class="text-xs font-medium text-slate-600 mb-1">Waktu Upload</p>
                                            <p class="text-sm font-semibold text-slate-900"><?php echo e($payment->created_at->format('d M Y H:i')); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        <div class="p-4 bg-slate-50 rounded-lg border border-slate-200">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-slate-900"><?php echo e($payment->registration->alamat_sekolah); ?></p>
                                                </div>
                                                    <div>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-slate-900"><?php echo e($payment->registration->provinsi); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs text-slate-600">Kab/Kota</p>
                                                        <p class="text-sm text-slate-900"><?php echo e($payment->registration->kab_kota); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs text-slate-600">Kecamatan</p>
                                                        <p class="text-sm text-slate-900"><?php echo e($payment->registration->kecamatan ?? '-'); ?></p>
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <div class="p-4 bg-slate-50 rounded-lg border border-slate-200">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <?php if($payment->registration->classes): ?>
                                                <div>
                                                    <p class="text-xs text-slate-600">Kelas</p>
                                                    <p class="text-sm text-slate-900"><?php echo e($payment->registration->classes->name); ?></p>
                                                </div>
                                                <?php endif; ?>
                                                <div>
                                                    ...
                                                    <p class="text-sm font-semibold text-slate-900">
                                                        <?php echo e($totalPeserta); ?> orang
                                                        <span class="text-xs text-slate-600">(KS: <?php echo e($payment->registration->jumlah_kepala_sekolah); ?>, Guru: <?php echo e($payment->registration->jumlah_guru); ?>)</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                                        ...
                                        <img src="<?php echo e(Storage::url($payment->proof_file)); ?>" alt="Bukti Transfer" class="rounded border border-slate-300 shadow-sm" style="max-height: 400px;">
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div>
                                        <h6 class="text-sm font-semibold text-slate-800 mb-3 flex items-center">
                                            ...
                                            Daftar Peserta dari <?php echo e($payment->registration->nama_sekolah); ?>
                                        ...
                                        <div class="space-y-3">
                                                ...
                                                <div class="flex items-start justify-between">
                                                    <div class="flex-1">
                                                        <div class="flex items-center gap-2 mb-2">
                                                            ...
                                                            <div>
                                                                <h4 class="text-sm font-semibold text-emerald-900"><?php echo e($payment->registration->kepala_sekolah); ?></h4>
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 ml-12">
                                                            <div>
                                                                ...
                                                                <p class="text-sm text-emerald-900"><?php echo e($payment->registration->nik_kepala_sekolah ?? '-'); ?></p>
                                                            </div>
                                                            <div>
                                                                <span class="text-xs font-medium text-emerald-700">Email:</span>
                                                                <p class="text-sm text-emerald-900"><?php echo e($payment->registration->email ?? '-'); ?></p>
                                                            </div>
                                                            <div>
                                                                <span class="text-xs font-medium text-emerald-700">Surat Tugas:</span>
                                                                <?php if($payment->registration->surat_tugas_kepala_sekolah): ?>
                                                                <a href="<?php echo e(Storage::url($payment->registration->surat_tugas_kepala_sekolah)); ?>" target="_blank"
                                            ...
                                            <!-- Guru-guru -->
                                            <?php if($payment->registration->teacherParticipants->count() > 0): ?>
                                            <?php $__currentLoopData = $payment->registration->teacherParticipants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="mt-4"><?php echo e($validatedPayments->links()); ?></div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LMS\resources\views/admin/payments/index.blade.php ENDPATH**/ ?>