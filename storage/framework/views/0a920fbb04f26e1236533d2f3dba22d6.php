...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('super-admin.users.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nik')); ?>" maxlength="16" pattern="[0-9]{16}" placeholder="16 digit NIK">
                        <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('gelar')); ?>" placeholder="S.Pd, M.Pd">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_hp')); ?>" placeholder="08xxxxxxxxxx">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email_belajar_id')); ?>" placeholder="nama@belajar.id">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('golongan')); ?>" placeholder="III/c">
...
unset($__errorArgs, $__bag); ?>" rows="2"><?php echo e(old('alamat_sekolah')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('provinsi_peserta')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('kabupaten_kota')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="2"><?php echo e(old('alamat_lengkap')); ?></textarea>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LMS\resources\views/super-admin/users/create.blade.php ENDPATH**/ ?>