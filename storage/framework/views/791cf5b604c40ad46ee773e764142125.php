<div x-show="showCreateModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" @keydown.escape.window="showCreateModal = false">
    ...
    <div class="relative z-10 flex min-h-screen items-center justify-center p-4">
        ...
        <form action="<?php echo e(route($routePrefix . '.classes.store')); ?>" method="POST" class="divide-y divide-slate-100">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <option value="<?php echo e($activity->id); ?>" <?php echo e(old('activity_id') == $activity->id ? 'selected' : ''); ?>><?php echo e($activity->name); ?></option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('max_participants')); ?>">
...
<?php /**PATH C:\laragon\www\LMS\resources\views/super-admin/classes/partials/create-modal.blade.php ENDPATH**/ ?>