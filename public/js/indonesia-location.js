const locationData = {
    'Jawa Barat': {
        ...
        'Kabupaten Ciamis': ['Banjaranyar', 'Banjarsari', 'Baregbeg', 'Cijulang', 'Cihaurbeuti', 'Cijeungjing', 'Cikoneng', 'Cimaragas', 'Cipaku', 'Cisaga', 'Jatinagara', 'Kawali', 'Lakbok', 'Lumbung', 'Mangunjaya', 'Padaherang', 'Pamarican', 'Panawangan', 'Panjalu', 'Panumbangan', 'Purwadadi', 'Rajadesa', 'Rancah', 'Sadananya', 'Sindangkasih', 'Sukadana', 'Tambaksari'],
